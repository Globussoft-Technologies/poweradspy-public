...
const UserAdCopyDataCard = ({data}) => {

    const filteredData = data?.adCopySide.filter(creative =>
      ...
      return (
        <div className="border-l-[8px] rounded-[10px] border-l-[#80385c] border border-[#dddddd] w-full pl-[9px] pr-[18px] pb-[9px] pt-[18px] h-[420px] overflow-auto mb-[18px]">
          <div className="pb-[18px] border-b-[1px] border-[#dddddd] pl-[9px]">
            <span className="font-[600] text-[18px] text-[#80385c]">
              AdCopy Data
            </span>
          </div>
...
export default UserAdCopyDataCard;
