...
const { hideAds, getHiddenPostOwners, unHide } = require(
  "../../../../src/services/linkedin/controllers/hideAdsController"
);
...
describe("services/linkedin/controllers/hideAdsController > hideAds", () => {
...
describe("services/linkedin/controllers/hideAdsController > getHiddenPostOwners", () => {
  it("400 when user_id missing", async () => {
...
describe("services/linkedin/controllers/hideAdsController > unHide", () => {
  it("400 when user_id missing", async () => {
  ...
  it("500 + logger.error on SQL throw", async () => {
    ...
    expect(out).toEqual({ code: 500, message: "Error in LinkedIn unHide", error: "delete-fail" });
    expect(fakeLogger.error).toHaveBeenCalled();
  });
});
