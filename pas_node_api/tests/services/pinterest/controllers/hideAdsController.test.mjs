...
const { hideAds, getHiddenPostOwners, unHide } = require(
  "../../../../src/services/pinterest/controllers/hideAdsController"
);
...
describe("services/pinterest/controllers/hideAdsController > hideAds", () => {
...
describe("services/pinterest/controllers/hideAdsController > getHiddenPostOwners", () => {
  it("400 when user_id missing", async () => {
...
describe("services/pinterest/controllers/hideAdsController > unHide", () => {
  it("400 when user_id missing", async () => {
  ...
  it("500 + logger.error on SQL throw", async () => {
    ...
    expect(out).toEqual({ code: 500, message: "Error in Pinterest unHide", error: "delete-fail" });
    expect(fakeLogger.error).toHaveBeenCalled();
  });
});
