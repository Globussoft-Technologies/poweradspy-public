...
const { hideAds, getHiddenPostOwners, unHide } = require(
  "../../../../src/services/native/controllers/hideAdsController"
);
...
describe("services/native/controllers/hideAdsController > hideAds", () => {
...
describe("services/native/controllers/hideAdsController > getHiddenPostOwners", () => {
  it("400 when user_id missing", async () => {
...
describe("services/native/controllers/hideAdsController > unHide", () => {
  it("400 when user_id missing", async () => {
  ...
  it("500 + logger.error on SQL throw", async () => {
    ...
    expect(out).toEqual({ code: 500, message: "Error in Native unHide", error: "delete-fail" });
    expect(fakeLogger.error).toHaveBeenCalled();
  });
});
