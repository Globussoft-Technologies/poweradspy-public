...
const { hideAds, getHiddenPostOwners, unHide } = require(
  "../../../../src/services/google/controllers/hideAdsController"
);
...
describe("services/google/controllers/hideAdsController > hideAds", () => {
...
describe("services/google/controllers/hideAdsController > getHiddenPostOwners", () => {
  it("400 when user_id missing", async () => {
...
describe("services/google/controllers/hideAdsController > unHide", () => {
  it("400 when user_id missing", async () => {
  ...
  it("500 + logger.error on SQL throw", async () => {
    ...
    expect(out).toEqual({ code: 500, message: "Error in Google unHide", error: "delete-fail" });
    expect(fakeLogger.error).toHaveBeenCalled();
  });
});
