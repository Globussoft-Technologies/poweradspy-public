...
const { hideAds, getHiddenPostOwners, unHide } = require(
  "../../../../src/services/youtube/controllers/hideAdsController"
);
...
describe("services/youtube/controllers/hideAdsController > hideAds", () => {
...
describe("services/youtube/controllers/hideAdsController > getHiddenPostOwners", () => {
  it("400 when user_id missing", async () => {
...
describe("services/youtube/controllers/hideAdsController > unHide", () => {
  it("400 when user_id missing", async () => {
  ...
  it("500 + logger.error on SQL throw", async () => {
    ...
    expect(out).toEqual({ code: 500, message: "Error in YouTube unHide", error: "delete-fail" });
    expect(fakeLogger.error).toHaveBeenCalled();
  });
});
