...
/**
 * LinkedIn hide/favorite ads controller.
...
async function unHide(req, db, logger) {
  try {
    ...
    logger.error('Error in LinkedIn unHide', { error: err.message });
    return { code: 500, message: 'Error in LinkedIn unHide', error: err.message };
  }
}
