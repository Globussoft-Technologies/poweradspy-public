...
const META_INSERT_COLUMNS = [
  ...
  'facebook_ad_post_owners.post_owner_name|ru,fr,sp,ge,exactly', 'facebook_ad_post_owners.post_owner_lower', 'facebook_ad_post_owners.verified', 'facebook_ad_post_owners.page_created_date', 'facebook_ad_meta_data.destination_url', 'facebook_ad_meta_data.initial_url',
...
const LIBRARY_INSERT_COLUMNS = [
  ...
  'facebook_ad_variants.image_object|ru,fr,sp,exactly', 'facebook_ad_variants.image_celebrity|ru,fr,sp,exactly', 'facebook_ad_variants.image_brand_logo|ru,fr,sp,exactly', 'facebook_ad_variants.image_ocr|ru,fr,sp,exactly',
  'facebook_ad_post_owners.post_owner_name|ru,fr,sp,ge,exactly', 'facebook_ad_post_owners.post_owner_lower', 'facebook_ad_post_owners.verified', 'facebook_ad_post_owners.page_created_date', 'facebook_ad_meta_data.destination_url', 'facebook_ad_meta_data.initial_url', 'facebook_ad_meta_data.EUT', 'facebook_ad_meta_data.meta_ad_url',
