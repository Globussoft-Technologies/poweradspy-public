...
/**
 * Facebook OCR/OCB controller (thin).
 *
 * HTTP-facing layer for the image OCR/OCB pipeline: validates the request and
 ...
 * Mirrors the controller→service layering used by the landers endpoints.
 */
...
// GET getFBImageUrl — `status` accepted in the query string (also body, PHP parity).
