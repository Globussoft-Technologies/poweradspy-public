...
const CAPABILITY_DEFINITIONS = [
  ...
  // ─── Keyword Explorer ─────────────────────────────────────────────────────
  {
    ...
    routes: [
      ...
      { method: 'PATCH', path: '/api/v1/google/keywords/lists/:id/rename' },
      { method: 'DELETE', path: '/api/v1/google/keywords/lists/:id/delete' },
      { method: 'DELETE', path: '/api/v1/google/keywords/lists/:id/items/remove' },
    ],
