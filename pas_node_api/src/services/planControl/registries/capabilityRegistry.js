...
const CAPABILITY_DEFINITIONS = [
  ...
  ...[
    ['overview', 'Overview & activity', 'Summary totals and ad activity over time.', '/trends/overview', 'Overview and activity chart'],
    ['regions', 'Regional demand', 'Country and regional demand data.', '/trends/regions', 'Regional demand'],
    ['categories', 'Category analytics', 'Ads per category and rising category data.', '/trends/categories', 'Ads per category and Rising categories'],
    ['top_movers', 'Top movers', 'Top advertisers and calls-to-action ranked by ad volume.', '/trends/top', 'Top movers'],
    ['keywords', 'Top search keywords', 'Most-targeted Google search keywords.', '/trends/keywords', 'Top search keywords'],
    ['compare', 'Advertiser comparison', 'Search and compare advertisers inside Market Trends.', '/trends/search', 'Advertiser comparison'],
  ...
  ].map(([suffix, label, description, apiPath, location]) => ({
