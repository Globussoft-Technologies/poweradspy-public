...
const INSTA_INSERT_COLUMNS = [
  ...
  'instagram_ad_post_owners.post_owner_name|ru,fr,sp,ge,exactly', 'instagram_ad_post_owners.post_owner_lower', 'instagram_ad_meta_data.destination_url',
