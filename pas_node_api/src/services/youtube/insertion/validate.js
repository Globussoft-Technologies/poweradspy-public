...
const META_ADS_RULES = {
  ...
  post_date: 'required_unless:ad_position,SEARCHFEED_DISCOVERY,HOMEFEED_DISCOVERY,COMPANION|string',
  ...
  ad_url: 'required_unless:type,TEXT,RESPONSIVE,DISPLAY,IMAGE,TEXT_IMAGE|url',
