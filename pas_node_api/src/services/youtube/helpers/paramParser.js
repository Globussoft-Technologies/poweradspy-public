...
/**
 * YouTube-specific sort field mapping.
 * ES index uses flat field names (no youtube_ad.* prefix).
 * YouTube has views + dislikes instead of shares/impressions/popularity.
 */
