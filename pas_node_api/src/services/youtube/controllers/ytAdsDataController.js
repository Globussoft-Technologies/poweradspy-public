...
/**
 * YouTube ytAdsData controller — thin glue (mirrors GDN/gtext/LinkedIn).
...
async function ytAdsData(req, db, logger) {
  const ctx = { db, log: logger, network: 'youtube' };
  const body = req.body;
