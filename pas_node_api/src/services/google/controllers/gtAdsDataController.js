...
/**
 * GTEXT (Google Text) gtAdsData controller — thin glue (mirrors GDN/Facebook).
...
async function gtAdsData(req, db, logger) {
  const ctx = { db, log: logger, network: 'google' };
  const body = req.body;
