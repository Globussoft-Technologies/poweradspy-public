...
const NETWORKS = {
  ...
  google:    { slug: 'google',    prefix: 'GOOG', esId: 0, dbId: 0, database: process.env.GOOG_DATABASE || 'pasdev_gtext',     esIndex: process.env.GOOG_INDEX || 'google_ads_data_v2',   landerTable: 'google_ad_html_lander_content',    esIdField: 'google_ad.id' },
  native:    { slug: 'native',    prefix: 'NAT',  esId: 0, dbId: 0, database: process.env.NAT_DATABASE  || 'pasdev_native',    esIndex: process.env.NAT_INDEX  || 'native_search_mix_v2', landerTable: 'native_ad_html_lander_content',    esIdField: 'native_ad.id' },
