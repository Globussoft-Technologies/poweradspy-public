...
const srcModule = require("../../src/countries-analytics");
const handler = vi.fn();
srcModule.countryStatsWithFilter = handler;

const router = require("../../routes/countries-analytics");

describe("routes/countries-analytics > registration", () => {
  it("exports an Express router", () => {
    expect(typeof router).toBe("function");
  });

  it("registers POST /counts pointing at countryStatsWithFilter", () => {
