      ...
      <div className="flex flex-col h-full">
        ...
        >
          {isAdmob && (!currentImg || imgError || ad.previewUnavailable) ? (
            // Same "Preview unavailable" treatment every other network falls
            // back to (see the imgError/previewUnavailable branch below) —
            // AdMob was previously showing a bespoke text placeholder instead.
            <div className="w-full min-h-[240px] flex flex-col items-center justify-center gap-2 bg-gradient-to-br from-zinc-900/70 to-zinc-800/40">
              <ImageIcon size={28} className="text-zinc-500" strokeWidth={1.5} />
            ...
            <div className="relative w-full h-full min-h-[220px]">
              ...
              <div className="absolute inset-0 pointer-events-none flex items-center justify-center overflow-hidden z-[15]">
                ...
                >
                  AD CREATIVE · {cornerNetwork.toUpperCase()}
                </span>
              </div>
            ...
            <div className="absolute top-0 left-0 w-16 h-16 z-30 pointer-events-none overflow-hidden">
              ...
              >
                <div className="flex items-center gap-1 pr-5 pb-7">
                  <img
                    src={PLATFORM_ICONS[cornerNetwork]}
                    alt={cornerNetwork}
          ...
          {isGoogleTransparency && (
            <div
              ...
              tooltip="Google Ads Transparency"
            >
